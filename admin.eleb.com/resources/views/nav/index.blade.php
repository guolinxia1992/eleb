...
<div class="x-body">
    ...
    <xblock>
        ...
        <a href="{{route('navs.create')}}" class="layui-btn" ><i class="layui-icon"></i>添加</a>
        <span class="x-right" style="line-height:40px">共有数据：{{count($navs)}} 条</span>
    ...
    <table class="layui-table">
        ...
        @foreach($navs as $nav)
            <tr>
                ...
                <td class="td-manage">
                    <a title="编辑" href="{{route('navs.edit',[$nav])}}">
