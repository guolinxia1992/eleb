...
<div class="x-body">
    ...
    <xblock>
        ...
        <a href="{{route('shops.create')}}" class="layui-btn" ><i class="layui-icon"></i>添加</a>
    ...
    <table class="layui-table">
        ...
        @foreach($shops as $shop)
            <tr>
                ...
                <td>
                    <img src="{{$shop->shop_img}}" alt="无法显示">
                </td>
                ...
                <td class="td-manage">
                    <a title="详情" href="{{route('shops.show',[$shop])}}">
                        <span class="glyphicon glyphicon-list-alt"></span>
                    </a>
                    <a title="编辑" href="{{route('shops.edit',[$shop])}}">
