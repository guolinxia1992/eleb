...
<div class="x-body layui-anim layui-anim-up" >
    ...
    @endif
    <form class="layui-form" method="post" action="{{route('roles.store')}}" enctype="multipart/form-data">
        ...
        <div class="layui-form-item">
            ...
            <div class="">
                ...
                <input type="checkbox"  name="permission[]"  autocomplete="off" class="" value="{{$permission->name}}">{{$permission->name}}
                @endforeach
            </div>
        </div>
